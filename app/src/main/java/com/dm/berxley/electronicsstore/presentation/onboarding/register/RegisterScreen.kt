...
fun RegisterScreen(navController: NavController) {
    ...
    var passwordConfirmationIsVisible by remember { mutableStateOf(false) }
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            singleLine = true,
            trailingIcon = {
                IconButton(onClick = { passwordConfirmationIsVisible = !passwordConfirmationIsVisible }) {
                    Icon(
                        tint = Color.White,
                        imageVector = if (passwordConfirmationIsVisible) Icons.Default.Visibility else Icons.Default.VisibilityOff,
                        contentDescription = if (passwordConfirmationIsVisible) "Hide Password" else "Show Password"
                    )
                }
            },
        ...
        Button(
            ...
            onClick = {
                if (!isLoading) {
                    ...
                    // Например:
                    // registerUser(email, password).invokeOnCompletion { isLoading = false }
                }
            }
        ) {
            Text(text = "Sign Up!")
